...
class ExampleSpider(scrapy.Spider):
    name = 'taopiaopiao_movies'
    allowed_domains = ['taopiaopiao.com'] #过滤不在范围内的域名
    start_urls = ['https://www.taopiaopiao.com/showList.htm?spm=a1z21.6646385.header.4.f6e833b729ZBe4&n_s=new']
